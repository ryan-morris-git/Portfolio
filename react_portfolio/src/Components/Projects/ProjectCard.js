...
function ProjectCard() {
    ...
    const getProjectList = (filter) => {
        fetch(`https://portfolio-backend-gc97c.ondigitalocean.app/get_projects?language=${filter}`, {headers: {'Content-Type': 'application/json'}, mode: "no-cors"}).then(res => res.json()).then(data => {
